    ...
    with tf.Session() as sess :
        ...
        for batch in batches :
            ...
            for i, img in enumerate(images) :
                batchImages[i] = img
            # print(iterations, batchLabels.shape, "CHECK", pred.get_shape()); exit()
            # print(batchLabels.shape, "CHECK", batchImages.shape, softmax, x, y, "SEEEE")
            # ans = sess.run(pred, feed_dict={x: batchImages, y: batchLabels, keepProb: P_DROPOUT})
            # print(ans.shape); exit()
