...
class MnistNet(object):
    ...
    def nn_layer(self, input_tensor, output_dim,
        ...
        print("shape_fcn:", shape_fcn, input_shape)
        ...
        with tf.name_scope(layer_name):
            ...
            with tf.name_scope('biases'):
                ...
                if "our_Operation" in str(type(input_tensor)):
                    a = input_tensor.fwd_func(*input_tensor.input_nodes)
                    # k = shape_fcn[0]
                    # print(k)
                    b = input_shape.fwd_func(*input_shape.input_nodes)
                    print(a, b, "HELLO", output_dim)
                else:
                    pass
